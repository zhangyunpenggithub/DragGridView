...
package com.qihoo360.jizhang.draggridview.helper;
...
import com.qihoo360.jizhang.draggridview.MyAdapter;
...
public class MyDefaultItemAnimator extends SimpleItemAnimator {
    ...
    private ArrayList<MyDefaultItemAnimator.MoveInfo> mPendingMoves = new ArrayList();
    private ArrayList<MyDefaultItemAnimator.ChangeInfo> mPendingChanges = new ArrayList();
    ArrayList<ArrayList<ViewHolder>> mAdditionsList = new ArrayList();
    ArrayList<ArrayList<MyDefaultItemAnimator.MoveInfo>> mMovesList = new ArrayList();
    ArrayList<ArrayList<MyDefaultItemAnimator.ChangeInfo>> mChangesList = new ArrayList();
    ...
    public void runPendingAnimations() {
        ...
        final boolean changesPending = !this.mPendingChanges.isEmpty();
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            while(var5.hasNext()) {
                ...
                if (holder instanceof MyAdapter.MyViewHolder2){
                    continue;
                }
            ...
            if (movesPending) {
                ...
                adder = new Runnable() {
                    public void run() {
                        ...
                        while(var1.hasNext()) {
                            MyDefaultItemAnimator.MoveInfo moveInfo = (MyDefaultItemAnimator.MoveInfo)var1.next();
                            if (moveInfo.holder instanceof MyAdapter.MyViewHolder2){
                                continue;
                            }
                            MyDefaultItemAnimator.this.animateMoveImpl(moveInfo.holder, moveInfo.fromX, moveInfo.fromY, moveInfo.toX, moveInfo.toY);
                        }

                        additions.clear();
                        MyDefaultItemAnimator.this.mMovesList.remove(additions);
                    }
                };
                if (removalsPending) {
                    if (((MyDefaultItemAnimator.MoveInfo)additions.get(0)).holder instanceof MyAdapter.MyViewHolder2){
                        return;
                    }
                    View view = ((MyDefaultItemAnimator.MoveInfo)additions.get(0)).holder.itemView;
            ...
            if (changesPending) {
                ...
                adder = new Runnable() {
                    public void run() {
                        Iterator var1 = arrayList.iterator();

                        while(var1.hasNext()) {

                            MyDefaultItemAnimator.ChangeInfo change = (MyDefaultItemAnimator.ChangeInfo)var1.next();
                            if (change.oldHolder instanceof MyAdapter.MyViewHolder2 || change.newHolder instanceof MyAdapter.MyViewHolder2){
                                continue;
                            }
                            MyDefaultItemAnimator.this.animateChangeImpl(change);
                        }

                        arrayList.clear();
                        MyDefaultItemAnimator.this.mChangesList.remove(arrayList);
                    }
                };
                if (removalsPending) {
                    ViewHolder holder = ((MyDefaultItemAnimator.ChangeInfo)arrayList.get(0)).oldHolder;
                    if (holder instanceof MyAdapter.MyViewHolder2){
                        return;
                    }
            ...
            if (additionsPending) {
                ...
                adder = new Runnable() {
                    public void run() {
                        ...
                        while(var1.hasNext()) {
                            ...
                            MyDefaultItemAnimator.this.animateAddImpl(holder);
                        }

                        arrayList.clear();
                        MyDefaultItemAnimator.this.mAdditionsList.remove(arrayList);
                    }
                };
                if (!removalsPending && !movesPending && !changesPending) {
                    ...
                    View view = ((ViewHolder)arrayList.get(0)).itemView;
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(this.getRemoveDuration()).alpha(0.0F).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                MyDefaultItemAnimator.this.dispatchRemoveStarting(holder);
            }

            public void onAnimationEnd(Animator animator) {
                animation.setListener((AnimatorListener)null);
                view.setAlpha(1.0F);
                MyDefaultItemAnimator.this.dispatchRemoveFinished(holder);
                MyDefaultItemAnimator.this.mRemoveAnimations.remove(holder);
    ...
    void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(1.0F).setDuration(this.getAddDuration()).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                MyDefaultItemAnimator.this.dispatchAddStarting(holder);
            }
            ...
            public void onAnimationEnd(Animator animator) {
                animation.setListener((AnimatorListener)null);
                MyDefaultItemAnimator.this.dispatchAddFinished(holder);
                MyDefaultItemAnimator.this.mAddAnimations.remove(holder);
                MyDefaultItemAnimator.this.dispatchFinishedWhenDone();
            }
        }).start();
    }
    ...
    public boolean animateMove(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        if (deltaX == 0 && deltaY == 0) {
            ...
            this.mPendingMoves.add(new MyDefaultItemAnimator.MoveInfo(holder, fromX, fromY, toX, toY));
            return true;
        }
    }
    ...
    void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(this.getMoveDuration()).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                MyDefaultItemAnimator.this.dispatchMoveStarting(holder);
            }
            ...
            public void onAnimationEnd(Animator animator) {
                animation.setListener((AnimatorListener)null);
                MyDefaultItemAnimator.this.dispatchMoveFinished(holder);
                MyDefaultItemAnimator.this.mMoveAnimations.remove(holder);
                MyDefaultItemAnimator.this.dispatchFinishedWhenDone();
            }
        }).start();
    }
    ...
    public boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder, int fromX, int fromY, int toX, int toY) {
        if (oldHolder instanceof MyAdapter.MyViewHolder2 || newHolder instanceof MyAdapter.MyViewHolder2){
            return true;
        }
        if (oldHolder == newHolder) {
            ...
            this.mPendingChanges.add(new MyDefaultItemAnimator.ChangeInfo(oldHolder, newHolder, fromX, fromY, toX, toY));
            return true;
        }
    }

    void animateChangeImpl(final MyDefaultItemAnimator.ChangeInfo changeInfo) {
        ViewHolder holder = changeInfo.oldHolder;
        final View view = holder == null ? null : holder.itemView;
        ViewHolder newHolder = changeInfo.newHolder;
        final View newView = newHolder != null ? newHolder.itemView : null;
        if (holder instanceof MyAdapter.MyViewHolder2 || newHolder instanceof MyAdapter.MyViewHolder2){
            return ;
        }
        ...
        if (view != null) {
            ...
            newViewAnimation.alpha(0.0F).setListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
                    MyDefaultItemAnimator.this.dispatchChangeStarting(changeInfo.oldHolder, true);
                }
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    view.setTranslationX(0.0F);
                    view.setTranslationY(0.0F);
                    MyDefaultItemAnimator.this.dispatchChangeFinished(changeInfo.oldHolder, true);
                    MyDefaultItemAnimator.this.mChangeAnimations.remove(changeInfo.oldHolder);
                    MyDefaultItemAnimator.this.dispatchFinishedWhenDone();
                }
            }).start();
        }
        ...
        if (newView != null) {
            final ViewPropertyAnimator viewPropertyAnimator = newView.animate();
            this.mChangeAnimations.add(changeInfo.newHolder);
            viewPropertyAnimator.translationX(0.0F).translationY(0.0F).setDuration(this.getChangeDuration()).alpha(1.0F).setListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
                    MyDefaultItemAnimator.this.dispatchChangeStarting(changeInfo.newHolder, false);
                }

                public void onAnimationEnd(Animator animator) {
                    viewPropertyAnimator.setListener((AnimatorListener)null);
                    newView.setAlpha(1.0F);
                    newView.setTranslationX(0.0F);
                    newView.setTranslationY(0.0F);
                    MyDefaultItemAnimator.this.dispatchChangeFinished(changeInfo.newHolder, false);
                    MyDefaultItemAnimator.this.mChangeAnimations.remove(changeInfo.newHolder);
                    MyDefaultItemAnimator.this.dispatchFinishedWhenDone();
                }
            }).start();
        }
    ...
    private void endChangeAnimation(List<MyDefaultItemAnimator.ChangeInfo> infoList, ViewHolder item) {
        if (item instanceof MyAdapter.MyViewHolder2){
            return;
        }
        for(int i = infoList.size() - 1; i >= 0; --i) {
            MyDefaultItemAnimator.ChangeInfo changeInfo = (MyDefaultItemAnimator.ChangeInfo)infoList.get(i);
            if (changeInfo.newHolder instanceof MyAdapter.MyViewHolder2|| changeInfo.oldHolder instanceof MyAdapter.MyViewHolder2){
                continue;
            }
    ...
    private void endChangeAnimationIfNecessary(MyDefaultItemAnimator.ChangeInfo changeInfo) {
        if (changeInfo.oldHolder instanceof MyAdapter.MyViewHolder2){
            return;
        }
    ...
    private boolean endChangeAnimationIfNecessary(MyDefaultItemAnimator.ChangeInfo changeInfo, ViewHolder item) {
    ...
    public void endAnimation(ViewHolder item) {
        ...
        for(i = this.mPendingMoves.size() - 1; i >= 0; --i) {
            MyDefaultItemAnimator.MoveInfo moveInfo = (MyDefaultItemAnimator.MoveInfo)this.mPendingMoves.get(i);
        ...
        for(i = this.mMovesList.size() - 1; i >= 0; --i) {
            ...
            for(int j = moves.size() - 1; j >= 0; --j) {
                MyDefaultItemAnimator.MoveInfo moveInfo = (MyDefaultItemAnimator.MoveInfo)moves.get(j);
                if (moveInfo.holder == item) {
                    view.setTranslationY(0.0F);
                    view.setTranslationX(0.0F);
                    this.dispatchMoveFinished(item);
    ...
    public void endAnimations() {
        ...
        for(listCount = count - 1; listCount >= 0; --listCount) {
            MyDefaultItemAnimator.MoveInfo item = (MyDefaultItemAnimator.MoveInfo)this.mPendingMoves.get(listCount);
            View view = item.holder.itemView;
            if (item.holder instanceof MyAdapter.MyViewHolder2){
                continue;
            }
            view.setTranslationY(0.0F);
            view.setTranslationX(0.0F);
        ...
        for(listCount = count - 1; listCount >= 0; --listCount) {
            this.endChangeAnimationIfNecessary((MyDefaultItemAnimator.ChangeInfo)this.mPendingChanges.get(listCount));
        }
        ...
        if (this.isRunning()) {
            ...
            for(i = listCount - 1; i >= 0; --i) {
                ...
                for(j = count - 1; j >= 0; --j) {
                    MyDefaultItemAnimator.MoveInfo moveInfo = (MyDefaultItemAnimator.MoveInfo)changes.get(j);
                    ViewHolder viewHolder = moveInfo.holder;
                    if (viewHolder instanceof MyAdapter.MyViewHolder2){
                        continue;
                    }
            ...
            for(i = listCount - 1; i >= 0; --i) {
                ...
                for(j = count - 1; j >= 0; --j) {
                    ViewHolder viewHolder = (ViewHolder)changes.get(j);
                    View view = viewHolder.itemView;
                    view.setAlpha(1.0F);
            ...
            for(i = listCount - 1; i >= 0; --i) {
                ...
                for(j = count - 1; j >= 0; --j) {
                    this.endChangeAnimationIfNecessary((MyDefaultItemAnimator.ChangeInfo)changes.get(j));
                    if (changes.isEmpty()) {
